...
import { ClientArchitectureViewer as ArchitectureViewer } from "@/components/3d/ClientArchitectureViewer";
import {
  BeforeAfter,
  PresentationFormats,
  RenderGallery,
  ...
  return (
    <main>
      <section className="wrap case-head">
        ...
        <p className="eyebrow">
          {isVilla ? "Contemporary Hillside Residence" : project.location}
        </p>
      ...
      <section className="viewer-wrap">
        <ArchitectureViewer variant={project.variant} showMaterials={isVilla} />
      </section>
      {isVilla ? (
        <>
